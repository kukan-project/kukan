...
| PUT | `/packages/{nameOrId}` | Update dataset (full replacement) | Org editor |
...
| POST | `/organizations/{nameOrId}/purge` | Permanently delete soft-deleted organization | sysadmin |
