...
| `brand`            | string                   | none                                               | Web image brand (for the upcoming multi-brand build feature). **Leave unset until that feature lands** (an unknown build arg fails the image build) |
