...
The generation/embedding model ID can be switched from the admin dashboard above without redeploying. To run Ollama on a GPU, see the [Getting Started guide](/en/getting-started/).
