...
export const brandConfig: BrandConfig = {
  ...
  searchExampleQueries: ['Where are the evacuation shelters?', 'Statistics on childcare support'],
}
```
...
| `searchExampleQueries` | Example-query chips (shown on the top page and the search page). Empty array hides them (default). Use natural-language queries that actually match your catalog's data |
